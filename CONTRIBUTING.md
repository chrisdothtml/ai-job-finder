...
See [src/.scripts/analyze.ts](./src/.scripts/analyze.ts) for the entry point.
...
See [src/.scripts/compare-models.ts](./src/.scripts/compare-models.ts) for the entry point.
